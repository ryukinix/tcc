...
\begin{frame}{Extração de características}
  \begin{itemize}
  \item A realização da extração de características é realizada através de um
...
\begin{enumerate}
\item Dinâmicas coletivas em redes complexas referem-se ao estudo de
...
\item Alguns exemplos de dinâmicas coletivas em redes complexas
incluem a propagação de doenças em redes de contato.
\item A disseminação de informações ou rumores em redes sociais é
outro exemplo de dinâmica coletiva em redes complexas.
\item A formação de opiniões em grupos sociais e a sincronização de
relógios biológicos em redes de neurônios também são exemplos de
dinâmicas coletivas em redes complexas.
\end{enumerate}
\end{frame}
\begin{frame}{LCU}
  \textit{Labeled Component Unfolding} (LCU) é uma dinâmica baseada em
