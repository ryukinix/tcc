...
% Permite desenhar figuras lado a lado
...
%% essa desgraça aq ta eh fodendo bem legal as notas de rodapé!!!
...
\usepackage{placeins}         % /FloatBarrier (controlar posição das figuras)
% \begin{displayquote} ficam itálicos
\renewcommand{\mkbegdispquote}[2]{\itshape} % chktex 6
