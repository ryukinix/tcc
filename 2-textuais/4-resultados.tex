...
0.9418, que é próximo, mas ainda significativamente maior. É
...
no valor das métricas \textit{F1} e IoU. Nesse cenário, conclui-se que
...
peso nas arestas do grafo. No entanto, esse é apenas um dos fatores do
sistema dinâmico: também há a geração de partículas e a transição
entre os vértices. Em geral, a classe que representa o objeto é
cercada pelo plano de fundo, portanto, é provável que a maior rede
fora do objeto gere partículas com a classe do plano de fundo, o que,
por fim, pode forçar a dominação de vértices que deveriam fazer parte
da classe do objeto, gerando falsos-negativos.
...
superpixels na probabilidade de sobrevivência das partículas. Além
disso, seria útil explorar novas técnicas de extração de
