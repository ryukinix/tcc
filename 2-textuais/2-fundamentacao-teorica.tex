...
\begin{figure}[h!]
		...
		\Caption{\label{fig:transductive-vs-inductive}
          No aprendizado transdutivo não há estimação de uma função de inferência.
        }
		\centering
		\UFCfig{}{\fbox{\includegraphics[width=14cm]{figuras/transductive-vs-inductive}}}{\Fonte{\cite{vapnik1995}}}
\end{figure}
